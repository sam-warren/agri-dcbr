# Generated by Django 2.2 on 2019-05-31 18:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comm_type', models.CharField(choices=[('Email', 'email'), ('Mail', 'mail')], default='Email', max_length=10)),
                ...
                ('operation_name', models.CharField(blank=True, default='', max_length=32)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='operationrisk', to='api.Operator')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('operator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='riskfactoranimals', to='api.Operator')),
            ],
            options={
                'verbose_name_plural': 'RiskFactorAnimals',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assoc_URL', models.TextField(blank=True, default='', validators=[django.core.validators.URLValidator()])),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('operator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to='api.Operator')),
            ],
            options={
